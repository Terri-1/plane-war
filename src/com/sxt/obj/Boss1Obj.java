...
public class Boss1Obj extends GameObj{
    int helthy=10;
    public Boss1Obj(Image img, int x, int y, double speed) {
        super(img, x, y, speed);
    }
...
Game1.score+=100;
    ...
    public Boss1Obj(Image img, int width, int height, int x, int y, double speed, Game1 frame) {
